...
namespace Cars.Tests.JustMock
{
    ...
    public class CarsControllerTests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void DetailsShouldThrowArgumentNullExceptionIfIdDoesNotExists()
        {
            var model = this.GetModel(() => this.controller.Details(int.MaxValue));
        }

        [TestMethod]
        public void DetailsShouldReturnExistingCar()
        {
            var model = this.GetModel(() => this.controller.Details(1)) as Car;
            Assert.AreEqual(1, model.Id);
            Assert.AreEqual("Audi", model.Make);
            Assert.AreEqual("A5", model.Model);
            Assert.AreEqual(2005, model.Year);
        ...
        [TestMethod]
        public void SearchShouldReturnListOfCars()
        {
        ...
        [TestMethod]
        public void SortByMakeShouldReturnOrderedList()
        {
        ...
        [TestMethod]
        public void SortByYearShouldReturnOrderedList()
        {
        ...
        public void SortShouldThrowArgumentExceptionIfSearchParameterNotKnown()
        {
